...
She likes grapes grown in a natural state and is an enthusiastic believer in allowing things to go their own course. She positively loves wild ferments.")
    ...
    Producer.create!(Farmphotos: ["http://southaustralia.traveller.com.au/wp-content/uploads/2017/04/tasting-australia-1.jpg","http://www.afr.com/content/dam/images/g/y/l/x/1/8/image.related.afrWideArticleLead.940x529.gyljfc.png/1510641289672.jpg","https://3c1703fe8d.site.internapcdn.net/newman/gfx/news/hires/2016/winemakerjus.jpg"], speciality: "winemaker", name: "Steven Reed", city: cities[3], latitude: coordinates[3][0], longitude: coordinates[3][1], photo: "https://i.pinimg.com/564x/43/93/37/439337046236b0cf18257df5db9f492f.jpg", description: "Steven, a winemaker in his own right, acknowledges what everyone who has met the man behind Block Wines knows: that he is all consumed by wine.
Steven is renowned for his remarkable ability to cipher the soils of his Gold Coast home into graceful, thrilling rieslings. He is enthralled by the grape, and drinkers, in turn, are enchanted by his interpretation of the classic white variety.
")
...
")
    ...
    Producer.create!(speciality: "cook", name: "Maria Burton", city: cities[4], latitude: coordinates[4][0], longitude: coordinates[4][1], photo: "http://www.organicauthority.com/wp-content/uploads/2015/10/female-tomato-farmer.jpg", description: "There are couple of culinary experts who claims such dedication and motivation from their local land as Maria Burton. She stood second among the most dazzling war of top 10 chefs in world for 2017.")
  puts "cooks made"
