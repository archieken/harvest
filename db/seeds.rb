...
#types = farmer, butcher, fishermen.
  ...
  puts "D&G Farmers made"
    ...
    Producer.create!(speciality: "baker", name: "Jill Hawkins", city: cities.sample, photo: "http://cdn.modernfarmer.com/wp-content/uploads/2015/01/farmingwomen_hero.jpg", description: "Archie Kenwright is a 3rd generation farmer specialising in growing swiss potatoes and brown onions.")
    Producer.create!(speciality: "baker", name: "Bryce Carrell", city: cities.sample, photo: "https://regmedia.co.uk/2015/05/01/free_range_chicken_and_farmer_photo_via_shutterstock.jpg", description: "Archie Kenwright is a 3rd generation farmer specialising in growing swiss potatoes and brown onions.")
