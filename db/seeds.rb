...
")
  ...
  # puts "Fisher made"
    ...
    Producer.create!(Farmphotos: ["http://ragus.co.uk/wp-content/uploads/2015/09/A-Baker-Within-A-Bakery.png","https://www.cvae.nl/sites/default/files/field/image/shutterstock_59293864_medium.jpg","https://d3ciwvs59ifrt8.cloudfront.net/79757705-6d10-4113-a363-e4e3e4f169f4/b73524c5-069b-491a-8241-9f3824132109.jpg"], speciality: "baker", name: "Oliver Baker", city: cities[3], latitude: coordinates[3][0], longitude: coordinates[3][1], photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Farmer%2C_Nicaragua.jpg/1200px-Farmer%2C_Nicaragua.jpg", description: "He became a baker because of his love of good bread. He was two years into an accounting and finance degree when he changed to culinary and decided to turn his lifelong hobby of baking into a career.")
...
")
  ...
  puts "Creating cooks"
    Producer.create!(speciality: "cook", name: "Alex Harrington", city: cities[4], latitude: coordinates[4][0], longitude: coordinates[4][1], photo: "https://i.pinimg.com/564x/f0/78/64/f07864f6f907bf61662d178f7d07c838.jpg", description: "There are couple of culinary experts who claims such dedication and motivation from their local land as Alex Harrington. She stood second among the most dazzling war of top 10 chefs in world for 2017.")
    ...
    Producer.create!(speciality: "cook", name: "Nigella Norris", city: cities[4], latitude: coordinates[4][0], longitude: coordinates[4][1], photo: "https://i.pinimg.com/564x/95/60/f1/9560f1f5ef96c4693a2ce9160d062493.jpg", description: "Nigella is the Leonel Messi of cooking in the day. Nigella can always be seen to be handling the pan with incredible finesse. Her cooking skills are next to none.")
    Producer.create!(speciality: "cook", name: "Rick Bay", city: cities[4], latitude: coordinates[4][0], longitude: coordinates[4][1], photo: "https://i.pinimg.com/564x/c5/5e/55/c55e554c98c73774ef21723299618ef3.jpg", description: "Rick displays his one of a kind culinary combined singing abilities whilst in the kitchen. He is a an absolute legend in his home town of Byron Bay.
")
    Producer.create!(speciality: "cook", name: "Marta Stand", city: cities[4], latitude: coordinates[4][0], longitude: coordinates[4][1], photo: "https://i.pinimg.com/564x/57/9d/82/579d82a4e7b20dbf7cb906fa9c416b25.jpg", description: "Marta learned to cook from her grandma when she was just a girl. She now delights in adapting these recipes into modern day masterpieces.")
